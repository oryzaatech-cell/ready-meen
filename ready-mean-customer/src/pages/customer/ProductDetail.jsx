        ...
        {soldOut ? (
          ...
          <div className="fixed left-0 right-0 mx-auto max-w-lg px-4 z-30 md:bottom-4" style={{ bottom: 'calc(var(--bottom-nav-h, 66px) + env(safe-area-inset-bottom, 0px) + 8px)' }}><div className="bg-white/95 backdrop-blur-lg rounded-2xl border border-gray-100 p-4 shadow-lg shadow-gray-200/50">
            <div className="flex items-center justify-between">
              ...
              {added ? (
                <Button size="lg" className="min-h-[52px] rounded-xl bg-emerald-600 hover:bg-emerald-600 cursor-default" disabled>
                  Added! ✓
                </Button>
              ) : (
                <Button onClick={handleAddToCart} size="lg" className="min-h-[52px] rounded-xl shadow-md shadow-primary-600/15 transition-all duration-300 hover:-translate-y-0.5">
