...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 px-4 py-8">
      {/* Decorative blobs */}
      ...
      <div className="w-full max-w-sm relative z-10 animate-slide-up">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Join Ready Meen</h1>
          <p className="text-sm text-gray-500 mt-1">Start selling fresh fish online</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl shadow-gray-200/50 border border-gray-100/80 p-6 space-y-5">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="pt-2 border-t border-gray-100">
              <p className="text-xs text-gray-400 mb-3">Optional details — you can add these later</p>
